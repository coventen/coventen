    ...
    const features = [
        {
            ...
            title: "NDT Services",
            desc: `Leading Industrial CT, Xray and NDT services 
            Show list of NDT services including Spectro, Xray, laser and other method
            Leading Industrial CT, Xray and NDT services 
            Show list of NDT services including Spectro, Xray, laser and other method`
        ...
        },
        {
            ...
            desc: `200 + environmental chambers
            More than 150 humidity, altitude, vibration and shock testing chambers
            `
        },
        {
            icon:
            ...
            desc: `Harmonizing technology and passion, Acoustic Testing creates immersive soundscapes that elevate your creations to new auditory heights.`
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            title: "Microscopic Testing",
            desc: `We are leading with more than 20 dedicated facilities in complete microscopic testing services including light, bifocal, electron and all other types microscope`
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            title: "Automotive and EV support",
            desc: `We are Leaders in Battery and Automotive Electronics testing`
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            desc: `We offer relevantly sophisticated component failure analysis for automotive, ev and electronic components 
            We have team of experts from premier institutes across the country in guiding our customers in failure analysis 
            `
        },
    ]
