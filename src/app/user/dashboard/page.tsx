    ...
    return (
        <div className='p-4 h-full max-h-screen  flex flex-col space-y-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3  lg:grid-cols-5 lg:grid-rows-4 h-full  max-h-full gap-2'>
                {/* notification */}
                <section className='lg:col-span-2 lg:row-span-full border  rounded-md h-full max-h-full space-y-3 p-2 lg:py-6'>
                    <p className=' font-medium text-xl mb-3'>Notification</p>
                    {
                        [...Array(4)].map((_, i) =>
                            <div key={i}>
                                <NotificationCard />
                ...
                {/* emty -1 */}
                <section className='lg:col-span-1 lg:row-span-full  border  h-full max-h-full'>
                ...
                <section className='lg:col-span-2 lg:row-span-full border lg:py-4 rounded  h-full max-h-full'>
                    <div className='h-full w-full grid grid-rows-4 gap-2'>
                        <div className='row-span-2  h-full w-full p-2'>
                            <p className=' font-medium text-xl mb-5'>Tickets Unsloved</p>
                                        ...
                                        <div key={i} className='w-full flex items-center justify-between px-3 py-2 border-b'>
                                            <div className='flex items-center  space-x-3'>
                                                ...
                                                <div className='text-sm'>
                                                    ...
                                                    <p className='text-desktopText text-xs xl:text-base'>#12234</p>
                                                    <p className='text-desktopTextLight text-[10px] xl:text-sm'>15th May 10:00 AM</p>
                                                </div>
                                            </div>

                                            <div className='flex items-center justify-center space-x-3'>
                                                <div className='text-[10px] xl:text-sm  hidden text-red-500 font-semibold xl:flex items-center justify-center space-x-2'>
                                                    <p>high</p>
                                                    <span><FaArrowUp /></span>
                                                </div>
