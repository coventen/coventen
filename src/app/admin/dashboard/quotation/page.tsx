        ...
        <>
            <div className="w-full  bg-white rounded-lg py-4 md:py-7 px-4 md:px-8 xl:px-10 min-h-[80vh]">
                ...
                <div className='flex items-center justify-end'>
                    <div>
                        <Link href='/admin/dashboard/quotation/create_quotation' className="focus:ring-2 focus:ring-offset-2 focus:ring-primary mt-4 sm:mt-0 inline-flex items-start justify-start px-6 py-3 bg-primary hover:bg-primary focus:outline-none  ">
