    ...
    return (
        <>
            ...
            <section className="grid lg:grid-cols-3 md:grid-cols-2 gap-6 w-full max-w-6xl">
                {
                    statsData.map((item) =>
                        <div key={item.title} className="flex items-center p-4 bg-white rounded dark:bg-darkBgLight dark:text-white">
                            ...
                            <div className="flex-grow flex flex-col ml-4">
                                ...
                                <div className="flex items-center justify-between">
                                    <span className="text-dimText dark:text-darkDimText">{item.title}</span>
            ...
            <section className="grid lg:grid-cols-2 gap-6 w-full my-8 rounded">
                <div className="bg-white rounded shadow dark:bg-darkBgLight dark:text-white">
                    <p className="focus:outline-none px-5 pt-5 text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal ">Notifications</p>
                    <NotificationBlck setSlideOverOpen={setSlideOverOpen} />
                </div>
                <div className="bg-white rounded shadow dark:bg-darkBgLight dark:text-white">
                    <p className="focus:outline-none px-5 pt-5 text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal ">Tickts</p>
                    <TicketBlock />
                </div>
            </section>
