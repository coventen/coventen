    ...
    return (
        ...
        <div className="flex h-screen antialiased text-gray-800">
            <div className="flex flex-row h-full lg:max-h-[85vh] w-full overflow-x-hidden">
                {/* side bar */}
                <div className="flex flex-col py-8 pl-6 pr-2 w-64 rounded-lg bg-white flex-shrink-0">
                ...
                <div className="flex flex-col flex-auto h-full px-6">
                    <div
                        className="flex flex-col flex-auto flex-shrink-0 rounded-lg bg-white h-full lg:max-h-[85vh] p-4"
                    >
