...
mutation Mutation($input: [ServicePageCreateInput!]!) {
    createServicePages(input: $input) {
      info {
        nodesCreated
      }
    }
...
mutation DeleteServicePages($where: ServicePageWhere) {
    deleteServicePages(where: $where) {
      nodesDeleted
    }
  }
`
...
const Main = () => {
    ...
    const createService = async (title: string) => {
        ...
        if (data.createServicePages.info.nodesCreated > 0) {
    ...
    const deleteService = async (id: string) => {
        ...
        if (data.deleteServicePages.nodesDeleted > 0) {
            ...
            <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                <div className="inline-block min-w-full  rounded-sm overflow-hidden">
                    ...
                    <table className="w-full leading-normal">
                        ...
                        <tbody>
                            {
                                data?.servicePages && data?.servicePages?.map((item: any, i: number) =>
                                    <tr key={i}>
