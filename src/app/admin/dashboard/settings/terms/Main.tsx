...
const Main = () => {
    ...
    // QUERY
    const { data: TermsData, loading, error, refetch } = useQuery(GET_ALL, { client })
    ...
    return (
        <>
            <TermsTab TermsData={TermsData?.termsPages} addNewTermsFn={addNewTerms} deleteTerms={deleteTerms} />
        </>
    );
};
