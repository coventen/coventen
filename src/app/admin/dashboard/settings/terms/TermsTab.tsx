...
// component
const TermsTab = ({ addNewTermsFn, TermsData, deleteTerms }: IAddProductTabsProps) => {
                    ...
                    <Tab.Panels>
                        <Tab.Panel>
                            <div className="w-full min-h-screen bg-white rounded-xl mt-2 py-2  -md">
                                <TermsTable TermsData={TermsData} deleteTerms={deleteTerms} />
                            </div>

                        </Tab.Panel>
                        <Tab.Panel>
                            <div className="w-full min-h-screen bg-white rounded-xl mt-2 py-2  -md">
                                <AddTerms addNewTermsFn={addNewTermsFn} setTab={setTab} />
                            </div>
                        </Tab.Panel>
                    </Tab.Panels>
