...
mutation CreateSubSolutions($input: [SubSolutionCreateInput!]!) {
    createSubSolutions(input: $input) {
      info {
        nodesCreated
...
const Main = () => {
    ...
    const createCommunication = async () => {
        ...
        if (data.createSubSolutions.info.nodesCreated) {
            toast.success("Sub service created successfully")
            router.push('/admin/dashboard/settings/solution_page/sub_solution')
        }
    ...
    useEffect(() => {
        ...
        if (data?.solutionPages?.length) {
            setSelectedType(data?.solutionPages[0]?.id)
        }

    }, [data?.solutionPages?.length])
        ...
        <form onSubmit={handleSubmit} className='bg-white rounded p-5 '>
            ...
            <div className="mb-5 ">
                ...
                <div className="relative inline-flex w-full">
                    ...
                    >
                        {
                            data?.solutionPages && data?.solutionPages.map((service: any) =>
