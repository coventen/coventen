                    ...
                    data && data.map((item, idx) => (
                        <tr key={item?.id} className=''>
                            ...
                            <td className="text-right whitespace-nowrap space-x-3">
                                <Link href={`/desktop_vendor/dashboard/invoice/preview/${item?.id}`} className="py-2 px-3 text-gray-600 hover:text-gray-500 duration-150 hover:bg-gray-50 border rounded-lg">
                                    View
                                </Link>
