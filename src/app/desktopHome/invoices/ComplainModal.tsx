...
function ComplainModal({ isOpen, setIsOpen, addComplain }: IComplainModal) {
    ...
    const handleSubmit = async (e: any) => {
        ...
        if (description.length) {
            addComplain(description, "COMPLAINED")
        }
    }
                    ...
                    <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        >
                            ...
                            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                                <p className="focus:outline-none pt-4 pb-8 text-base text-center sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-gray-800">Complain</p>
