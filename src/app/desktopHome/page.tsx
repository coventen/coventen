...
const DesktopHome = () => {
    ...
    return (
        <div className='p-4 h-full max-h-screen  flex flex-col space-y-4'>
            ...
            <div className='grid grid-cols-1  lg:grid-cols-5 lg:grid-rows-4 h-full  max-h-full gap-2'>
                {/* notification */}
                <section className='lg:col-span-2 lg:row-span-full border border-desktopPrimaryLight rounded-md h-full max-h-full space-y-3 p-2'>
                    ...
                    <div className='h-full w-full grid grid-rows-4 gap-2'>
                                        ...
                                        <div key={i} className='w-full flex items-center justify-between px-3 py-2 border-b'>
                                            <div className='flex items-center  space-x-3'>
                                                ...
                                                <div className='text-sm'>
                                                    ...
                                                    <p className='text-desktopText text-base'>#12234</p>
                                                    <p className='text-desktopTextLight'>15th May 10:00 AM</p>
                                                </div>
                                            </div>

                                            <div className='flex items-center justify-center space-x-3'>
                                                <div className='text-sm text-red-500 font-semibold flex items-center justify-center space-x-2'>
                                                    <p>high</p>
                                                    <span><FaArrowUp /></span>
                                                </div>
                                                <button className='bg-primary/10 text-primary text-sm  px-4 py-1 rounded-2xl'>
                                                    Open
                                                </button>
                        ...
                        <div className=' bg-gray-100 h-full w-full max-h-full overflow-hidden '>
                            ...
                            <div className="absolute bottom-2 text-white opacity-50 text-sm">
                                Icon made by <a href="https://www.flaticon.com/authors/freepik">Freepik</a> from <a href="https://www.flaticon.com/free-icon/cloudy_1146869?term=cloudy&page=1&position=2&related_item_id=1146869">www.flaticon.com</a>
                            </div>
                        </div>
