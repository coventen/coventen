                                ...
                                [...Array(6)].map((_, i) =>
                                    <div key={i} className="p-2 sm:w-1/2 w-full">
                                        <div className="bg-gray-100 rounded flex p-4 h-full ">
                                            <svg fill="none" stroke="currentColor" strokeLinecap="round" stroke-linejoin="round" stroke-width="3" className="text-primary w-6 h-6 flex-shrink-0 mr-4" viewBox="0 0 24 24">
