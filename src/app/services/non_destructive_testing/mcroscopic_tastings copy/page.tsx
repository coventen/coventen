            ...
            <main className=' relative z-20'>
                <article className='bg-transparent pt-44'>
                    <header className="mx-auto    max-w-screen-lg rounded-t-lg bg-white pt-16 text-center shadow-lg ">
                        ...
                        <h1 className="mt-2 text-4xl font-bold text-primaryText sm:text-5xl">Infrared Thermography (IRT)</h1>
                        <p className="mt-6 text-lg text-gray-700">You come way farther than you expected</p>
