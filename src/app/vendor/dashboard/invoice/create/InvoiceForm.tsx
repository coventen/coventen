                    ...
                    <div className="bg-white rounded p-4 px-4 md:p-8 mb-6">
                        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-2">
                            ...
                            <div className="lg:col-span-2">
                                <form onSubmit={handleSubmit(handleCreating)} className="grid grid-cols-1 gap-6 max-w-2xl">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="h-10 w-28  flex border border-gray-300  rounded items-center mt-1">
                                                        ...
                                                        <input name="soda" id="soda" placeholder="0"
                                                            className="px-2 text-center appearance-none  text-gray-800 w-full bg-transparent border-none outline-none"
                                                            readOnly
                                                            value={serviceCount} />
                                                        <button type='button' onClick={() => setServiceCount(serviceCount + 1)} className="cursor-pointer outline-none focus:outline-none border-l border-gray-300 transition-all text-gray-500 hover:text-blue-600">
