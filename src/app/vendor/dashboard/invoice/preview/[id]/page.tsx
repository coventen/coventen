              ...
              <div className="flex justify-between">
                {invoiceData?.sentBy === "VENDOR" ? (
                  <>
                    <div>
                      <div className="mt-4">
                        <h3 className="text-3xl font-semibold text-gray-800 dark:text-gray-200 capitalize">
              ...
              <div className="mt-8 grid sm:grid-cols-2 gap-3">
                <div className="mb-10">
                  ...
                  <div className="">
                    ...
                    <address className="mt-1 text-sm not-italic text-gray-500">
                      #504, 2nd Phase, 6th Stage, BTM Layout, Off Bannerghatta
                      road
                      <br />
                      {/* <br /> */}
                      Bangalore Karnataka 560076 , India
                ...
                <div className="sm:text-right space-y-2 mt-4">
                  {/* <!-- Grid --> */}
                  <div className="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
                    <dl className="grid sm:grid-cols-3 gap-x-1">
                      ...
                      <dd className="col-span-1 text-gray-500">
                        {invoiceData?.createdAt.slice(0, 10) || "N/A"}
                      </dd>
                    </dl>
                  </div>
                  <div className="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
                    <dl className="grid sm:grid-cols-3 gap-x-1">
                      ...
                      <dd className="col-span-1 text-gray-500">
                        {invoiceData?.expiryDate?.slice(0, 10) || "N/A"}
                      </dd>
                    </dl>
                  </div>
                  {/* <!-- End Grid --> */}
