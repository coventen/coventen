                ...
                <div className="sticky top-0 h-16 z-[300000000]  bg-white dark:bg-gray-800  lg:py-2.5 border-b shadow-sm">
                    <div className="flex items-center justify-between space-x-4 px-6 2xl:container">
                        <div>
                            ...
                            <Link target="_blank" href='https://drive.google.com/uc?export=download&id=1Fxi8edftd557hpgh4LOwkP27rYXPte8d' className="hidden lg:flex gradient-bg px-2 py-2 rounded-md font-semibold text-white text-sm  items-center justify-center space-x-2">
                                <span>
                                    Get Our Application
                                </span>
